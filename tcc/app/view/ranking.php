  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-secondary">
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
        ...
        <a class="btn navbar-btn ml-2 text-white btn-secondary mx-1" href="cadastro.php"><i class="fa d-inline fa-lg fa-user-circle-o"></i>&nbsp;Cadastrar</a>
      </div>
    </div>
  </nav>
  <div class="py-5">
